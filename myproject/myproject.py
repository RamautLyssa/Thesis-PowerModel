...
def main():
    ...
    if (CpuChoice==1):
        ...
        L_cu = sh1.range('I7').value
        flops_4nodes = sh1.range('I6').value
        E_l1 = sh1.range('I8').value
        E_l2 = sh1.range('I9').value
        E_MEM = sh1.range('I10').value
        X_l1 = sh1.range('I11').value
        X_l2 = sh1.range('I12').value
        X_l3 = sh1.range('I13').value
